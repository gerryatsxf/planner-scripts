...
from ..models.hybrid_transaction_type import HybridTransactionType
...
class HybridTransaction:
    ...
    Attributes:
        ...
        deleted (bool): Whether or not the transaction has been deleted.  Deleted transactions will only be included in
            delta requests.
        type (HybridTransactionType): Whether the hybrid transaction represents a regular transaction or a
            subtransaction
        account_name (str):
        ...
        parent_transaction_id (Union[Unset, str]): For subtransaction types, this is the id of the parent transaction.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = HybridTransactionType(d.pop("type"))
        ...
        parent_transaction_id = d.pop("parent_transaction_id", UNSET)
