...
from ...models.get_transactions_by_payee_type import GetTransactionsByPayeeType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, None, GetTransactionsByPayeeType] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, None, GetTransactionsByPayeeType]):
