...
from ...models.get_transactions_by_account_type import GetTransactionsByAccountType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, None, GetTransactionsByAccountType] = UNSET,
    last_knowledge_of_server: Union[Unset, None, int] = UNSET,
) -> Dict[str, Any]:
    url = "{}/budgets/{budget_id}/accounts/{account_id}/transactions".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, None, GetTransactionsByAccountType]):
