...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[AccountsResponse, ErrorResponse]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[AccountsResponse, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    client: Client,
    last_knowledge_of_server: Union[Unset, None, int] = UNSET,
) -> Optional[Union[AccountsResponse, ErrorResponse]]:
    """Account list
