...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/budgets/{budget_id}/categories".format(client.base_url, budget_id=budget_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[CategoriesResponse, ErrorResponse]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[CategoriesResponse, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    client: Client,
    last_knowledge_of_server: Union[Unset, None, int] = UNSET,
) -> Optional[Union[CategoriesResponse, ErrorResponse]]:
    """List categories
